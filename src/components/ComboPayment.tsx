...
interface ComboPaymentProps {
  user: User | null;
}

export function ComboPayment({ user }: ComboPaymentProps) {
  ...
  const paymentDescription = paymentDetails?.paymentCode || sanitizeDescription(rentalId || 'COMBOPAYMENT');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/combos')}>Quay lại</Button>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 py-8">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Thanh toán đặt thuê combo</h1>
          <p className="text-gray-600 mt-2">{combo.name}</p>
        </div>
                    ...
                    <>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            <span className="font-semibold text-purple-600">{paymentDescription}</span>
                            <Button
                              variant="ghost"
                              size="sm"
            ...
            <CardContent className="py-12 text-center">
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-gray-600">
                  Đơn thuê combo của bạn đã được thanh toán và xác nhận
                </p>
