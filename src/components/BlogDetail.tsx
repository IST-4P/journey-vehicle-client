...
import { 
  ...
  Heart, Eye, BookOpen, Facebook, Twitter, Link as LinkIcon
} from 'lucide-react';
  ...
  const fetchArticle = async () => {
    ...
    try {
      ...
      const mockArticle: Article = {
        ...
        authorBio: 'Travel blogger với 5 năm kinh nghiệm khám phá Việt Nam và Đông Nam Á. Yêu thích phượt và nhiếp ảnh du lịch.',
        category: 'Du lịch',
        tags: ['Phượt', 'Việt Nam', 'Cẩm nang', 'Top 10'],
        coverImage: 'https://images.unsplash.com/photo-1593168098026-10d982cb9055?w=1200',
      ...
      const mockRelated: RelatedArticle[] = [
        {
          ...
          coverImage: 'https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?w=400',
          publishedAt: '2024-01-22'
        },
        {
          id: '3',
          title: 'Checklist Đồ Đi Biển Đầy Đủ Nhất',
          coverImage: 'https://images.unsplash.com/photo-1754491749176-2993a73e2f68?w=400',
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold">Về tác giả: {article.author}</h3>
                  </div>
                  ...
                  <Card className="overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center space-x-1 text-sm text-gray-500">
                        <Calendar className="h-3 w-3" />
                        <span>{new Date(related.publishedAt).toLocaleDateString('vi-VN')}</span>
                      </div>
                    </CardContent>
                  </Card>
                </Link>
