        ...
        <Dialog open={showLicenseUpload} onOpenChange={setShowLicenseUpload}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Tải lên thông tin giấy phép lái xe để xác thực</DialogDescription>
            </DialogHeader>
        ...
        <Dialog open={showCheckIn} onOpenChange={setShowCheckIn}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Xác nhận thông tin check-in để bắt đầu sử dụng xe</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
        ...
        <Dialog open={showBookingDetail} onOpenChange={setShowBookingDetail}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Thông tin chi tiết về đơn đặt xe của bạn</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                <ImageWithFallback
        ...
        <Dialog open={showAddForm} onOpenChange={setShowAddForm}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Thêm địa chỉ giao nhận xe mới</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
        ...
        <Dialog open={showCreateForm} onOpenChange={setShowCreateForm}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Gửi khiếu nại về vấn đề bạn gặp phải</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
