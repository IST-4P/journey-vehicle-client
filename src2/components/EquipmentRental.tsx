...
import { Filter, Package, Star, ChevronDown } from 'lucide-react';
...
export function EquipmentRental() {
      ...
      const mockEquipment: Equipment[] = [
        {
          ...
          brand: 'Coleman',
          description: 'Lều chống nước, dễ dàng lắp đặt, phù hợp cho gia đình 4 người',
          pricePerHour: 20000,
          information: ['Kích thước: 2.1m x 2.1m', 'Trọng lượng: 3.5kg', 'Chống nước'],
          quantity: 5,
          status: 'available',
        ...
        },
        {
          ...
          quantity: 8,
          status: 'available',
          images: ['https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=500'],
          rating: 4.7,
          reviewCount: 18
        },
        {
        ...
        },
        {
          ...
          pricePerHour: 25000,
          information: ['Độ phóng đại: 10x42', 'Chống nước', 'Phủ coating đa lớp'],
          quantity: 6,
          status: 'available',
          images: ['https://images.unsplash.com/photo-1580982172477-09502529c1af?w=500'],
          rating: 4.9,
          reviewCount: 21
        },
        {
        ...
        },
        {
          ...
          quantity: 7,
          status: 'available',
          images: ['https://images.unsplash.com/photo-1585909695284-32d2985ac9c0?w=500'],
          rating: 4.7,
          reviewCount: 16
        },
        {
          ...
          pricePerHour: 15000,
          information: ['Tải trọng: 200kg', 'Trọng lượng: 500g', 'Kích thước: 3x2m'],
          quantity: 9,
          status: 'available',
          images: ['https://images.unsplash.com/photo-1603640953238-0e52c21e2f56?w=500'],
          rating: 4.8,
          reviewCount: 27
        },
        {
        ...
        },
        {
          ...
          pricePerHour: 8000,
          information: ['Kích thước M/L', 'Chất liệu EVA', 'Đủ tiêu chuẩn an toàn'],
          quantity: 15,
          status: 'available',
  ...
  const uniqueBrands = Array.from(new Set(equipment.map(eq => eq.brand).filter(Boolean))) as string[];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-600 to-teal-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-green-100">Đầy đủ thiết bị hỗ trợ cho chuyến đi của bạn</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex items-end">
              {rentalHours > 0 && (
                <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-2 w-full">
                  <p className="text-sm text-green-700">Thời gian thuê: <span className="font-semibold">{rentalHours} giờ</span></p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-600">
              Tìm thấy <span className="font-semibold">{filteredEquipment.length}</span> thiết bị
            </div>
          </div>
              ...
              <div>
                ...
                <Select value={filters.priceRange} onValueChange={(value) => handleFilterChange('priceRange', value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="10000-20000">10.000đ - 20.000đ</SelectItem>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {paginatedEquipment.map((item) => {
                const totalPrice = rentalHours > 0 ? item.pricePerHour * rentalHours : item.pricePerHour;
